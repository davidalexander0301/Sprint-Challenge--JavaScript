...
stegosaurus.peroid = "Late Jurrasic";
...
*/
const animalNames = zooAnimals.map(item => {return item.animal_name .scientic_name});
...
const lowerCase = zooAnimals.foreach(item => {return item.animal_name.toLowerCase()});
